  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="mt-4 px-4">
        <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/12 via-card to-card p-5 shadow-card">
          <div className="flex items-center gap-4">
            <div className="grid h-16 w-16 shrink-0 place-items-center rounded-full bg-primary text-2xl font-extrabold text-primary-foreground shadow-pill">
              {initials}
            </div>
            ...
            <button className="tap shrink-0 rounded-full bg-background/80 px-3 py-1.5 text-[11px] font-bold text-foreground shadow-sm ring-1 ring-border">
              Edit
            </button>
          </div>
        </div>
        ...
        <div className="mt-3 grid grid-cols-2 gap-3">
          ...
          <Stat to="/favorites" Icon={Heart} label="Saved" value={favCount} />
        </div>
      </section>
